...
Partial Class Payment
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        lblPrice12.Text = Session("Cost13")
        lblPrice12.Text = Session("Cost14")
        lblPrice12.Text = Session("Cost15")
        lblPrice12.Text = Session("Cost16")
        lblPrice12.Text = Session("Cost17")
        lblPrice12.Text = Session("Cost18")
        lblPrice12.Text = Session("Cost19")
        lblPrice12.Text = Session("Cost20")
        ...
        lblQuantity12.Text = Session("Amount13")
        lblQuantity12.Text = Session("Amount14")
        lblQuantity12.Text = Session("Amount15")
        lblQuantity12.Text = Session("Amount16")
        lblQuantity12.Text = Session("Amount17")
        lblQuantity12.Text = Session("Amount18")
        lblQuantity12.Text = Session("Amount19")
        lblQuantity12.Text = Session("Amount20")
        ...
        lblTotal18.Text = Session("BuyEightteen")
